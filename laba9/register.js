document.addEventListener("DOMContentLoaded", () => {
    ...
    function handleRegisterSubmit(event) {
        ...
        if (!validRegisterData()) {
            ...
            registerButton.classList.add('form__submit_disable');  

            return;
        }

        postJSON(registerData)
    ...
    function rerenderForm() {
        registerData.email = emailField.value;
        registerData.password = passwordField.value;

        if (emailField.value && passwordField.value) {
            registerButton.removeAttribute('disabled'); 
            registerButton.classList.remove('form__submit_disable');
        } else {
            registerButton.setAttribute('disabled', ''); 
            registerButton.classList.add('form__submit_disable');           
        }       
