...
<body>
  ...
  <main class="main">
    <div class="title-block container">
      ...
      <h2 class="title-block__subtitle">The road ahead might be paved - it might not be.</h2>
    </div>
    <div class="content">
      <img class="content__image" src="../laba1/images/image.png" alt="image">
      <div class="content__text container">
        ...
        <p>But there was life, abroad in the land and defiant. Down the frozen waterway toiled a string of wolfish dogs.
          ...
          prominent, occupying most of the space, was the long and narrow oblong box.</p>
        <p>In advance of the dogs, on wide snowshoes, toiled a man. At the rear of the sled toiled a second man. On the
          ...
          in the end come to the cessation of movement.</p>
        <p>But at front and rear, unawed and indomitable, toiled the two men who were not yet dead. Their bodies were
          ...
          of a world as remote and alien and pulseless as the abysses of space.</p>
      </div>
    </div>
  </main>
  <footer class="footer">
